...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<script type="text/javascript">
		...
		//提交表单
		function submitForm(){
			$("#innerOrderFormSuccessListdiv").load('orderFormSuccess?op=query',$("#orderFormSuccessForm").serialize());
		};
		//立即查询
		...
		$("#queryOrderForms").click(function(){
			var searchForm = $("#orderFormSuccessForm")[0];
	...
	<div id="orderFormListDiv">
			...
			<form class="form-horizontal" id="orderFormSuccessForm">
				<!-- 隐藏表单域 -->
			...
			<div class="btn-group" style="margin-left: 8px;margin-top: -30px">
					...
					<button id="deleteOrderForm" class="btn btn-default" type="button">
						<span class="glyphicon glyphicon-remove">删除选中</span>
					</button>
			</div>
			
			<div id="innerOrderFormSuccessListdiv"></div>	 
		</div>