...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<form class="form-horizontal" id="editOrderFormForm" >
		<input type="hidden" value="${orderForm.orderFormId }" name="orderFormId"/>
		<input type="hidden" value="${orderForm.userId }" name="userId"/>
		<div class="row" >
			<table class="table table-hover table-condensed">
				...
				<tr>
					<th style="text-align: left;">收获人:</th>
					<td style="text-align: left;">
						<input type="text" class="form-control" value="${orderForm.address.receiverName }" name="receiverName"/>
					</td>
				</tr>
				<tr>
					<th style="text-align: left;">联系方式:</th>
					<td  style="text-align: left;">
						<input type="text" class="form-control" value="${orderForm.address.receiverTel }" name="receiverTel"/>
					<td>
				</tr>
				<tr>
					<th style="text-align: left;">收获地址:</th>
					<td  style="text-align: left;">
						<input type="text" class="form-control" value="${orderForm.address.addressInfo }" name="addressInfo"/>
					<td>
				</tr>
				<tr>
					<th style="text-align: left;">邮编信息:</th>
					<td  style="text-align: left;">
						<input type="text" class="form-control" value="${orderForm.address.postcode }" name="postcode"/>
					<td>
				</tr>
			</table>
			...
			<table class="table table-hover table-condensed">
				...
				<tr>
					<c:forEach items="${orderForm.orderStateList }" var="orderStateList">
						<c:if test="${orderStateList.orderStateDesc=='待收货' }">
							<th>发货时间:</th>
							<td  style="text-align: left;">
								${orderStateList.orderStateTime }
							<td>
			...
			<table class="table table-bordered table-hover table-condensed">
				...
				<tr>
					<td colspan="10" style="text-align: right;">
						<input type="text" value="${orderForm.orderFormPrice }" style="color:red;font-size: 1.2em" name="orderFormPrice"/>
					</td>
				</tr>
				</tbody>
			</table>
